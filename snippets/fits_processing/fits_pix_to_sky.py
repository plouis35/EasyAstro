...
if len(sys.argv) == 1:
  print(" ")
  print("Usage: fits_pix_to_sky.py infile.fits pixels.txt skycoords.txt  ")
  print(" ")
...
# Use the wcs header of an image input file for the celestial coordinate conversion parameters
