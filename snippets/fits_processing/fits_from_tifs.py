...
for infile in infiles:
  ...
  # The image returned by PIL is inverted as stored in the np array
  # Flip it up/down so that the FITS image appears in the same
  #   orientation as the original tif image

  # Additional image processing could go here
  
  outimage = np.flipud(fimage)
