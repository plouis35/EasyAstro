...
# Converted to Boolean true or 1, this mask will block 
#   that part of the image for subsequent processing with
#   fits_mask.py or will unblock it with fits_unmask.py
