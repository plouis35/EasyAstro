...
if len(sys.argv) == 1:
  print(" ")
  print("Usage: fits_median_1d.py  outfile.fits infile1.fits infile2.fits ...   ")
  print(" ")
  sys.exit("Create a median image from a time- or z-axis stack\n ")
elif len(sys.argv) >=4:
  outfile = sys.argv[1]
  infiles = sys.argv[2:]
else:
...
outhdr['history'] = 'Median of %d images by fits_median_1d' %(nimages,)
